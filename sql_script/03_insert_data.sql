...
-- Customers
INSERT INTO customer (full_name, phone, email, address, order_role) VALUES ('Jean Mugabo',     '+250788100200', 'jean@email.com',   'Kimironko, Kigali', 'Sender');
INSERT INTO customer (full_name, phone, email, address, order_role) VALUES ('Alice Uwimana',   '+250788100300', 'alice@email.com',  'Nyamirambo, Kigali', 'Receiver');
INSERT INTO customer (full_name, phone, email, address, order_role) VALUES ('David Niyonzima', '+250788100400', 'david@email.com',  'Gisozi, Kigali', 'Sender');

-- Drivers
INSERT INTO driver (full_name, phone, license_no, plate_no) VALUES ('Patrick Habimana',  '+250791200100', 'RWA-LIC-001', 'RAB 123A');
INSERT INTO driver (full_name, phone, license_no, plate_no) VALUES ('Claude Iradukunda', '+250791200200', 'RWA-LIC-002', 'RAC 456B');
...
-- Packages
INSERT INTO package (package_code, sender_id, receiver_id, weight_kg, description, status) VALUES ('PKG-001', 1, 2, 2.50,  'Documents envelope', 'Pending');
INSERT INTO package (package_code, sender_id, receiver_id, weight_kg, description, status) VALUES ('PKG-002', 3, 1, 15.00, 'Electronics box',    'Pending');
